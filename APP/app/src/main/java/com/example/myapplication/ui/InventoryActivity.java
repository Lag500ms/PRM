...
public class InventoryActivity extends AppCompatActivity implements InventoryAdapter.OnItemClickListener, InventoryAdapter.OnItemLongClickListener {
    ...
    private void showDeleteConfirmationDialog(VehicleItem item) {
        new AlertDialog.Builder(this)
                .setTitle("Delete Item")
                .setMessage("Are you sure you want to delete this item?")
                .setPositiveButton("Delete", (dialog, which) -> deleteInventoryItem(item))
                .setNegativeButton("Cancel", null)
                .show();
    }

    private void deleteInventoryItem(VehicleItem item) {
        progressBar.setVisibility(View.VISIBLE);
        inventoryRepository.deleteInventory(currentInventoryId, new InventoryRepository.DeleteCallback() {
            @Override
            ...
            public void onError(String error) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(InventoryActivity.this, "Error deleting item: " + error, Toast.LENGTH_LONG).show();
            }
        });
    }
